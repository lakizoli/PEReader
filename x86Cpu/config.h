...
#define BX_USE_CPU_SMF 0 //1

#define BX_USE_MEM_SMF 0 //1
...
#define BX_SUPPORT_AVX 1 //0
#define BX_SUPPORT_EVEX 1 //0
...
#define BX_SUPPORT_REPEAT_SPEEDUPS 0 //1
...
// define SMP processor count (we have to have only one processor!)
...
#if BX_SUPPORT_A20
#  define A20ADDR(x)                ((bx_phy_address)(x) & sys->a20_mask)
#else
#  define A20ADDR(x)                ((bx_phy_address)(x))
#endif

#define BX_SET_ENABLE_A20(enabled)  bx_pc_system.set_enable_a20(enabled)
#define BX_GET_ENABLE_A20()         sys->get_enable_a20() 

// types of reset
#define BX_RESET_SOFTWARE 10
#define BX_RESET_HARDWARE 11 

#define BX_TICK1()                  bx_pc_system_c::tick1(sys)
#define BX_TICKN(n)                 bx_pc_system_c::tickn(sys, n)
#define BX_HRQ                      sys->HRQ
...
#else //CPU_HAS_DEVICES
#	define BX_INP(addr, len)			0
#	define BX_OUTP(addr, val, len)		0
