...
public:
  bx_bool INTR;
  bx_local_apic_c(BX_CPU_C *cpu, bx_pc_system_c* sys, bx_bool simulate_xapic, unsigned id);
 ~bx_local_apic_c() { }
...
BOCHSAPI_MSVCONLY int apic_bus_deliver_interrupt(BX_CPU_C* cpu, Bit8u vector, apic_dest_t dest, Bit8u delivery_mode, bx_bool logical_dest, bx_bool level, bx_bool trig_mode);
